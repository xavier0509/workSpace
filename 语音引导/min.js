...
var app = {
    ...
    receivedEvent: function(id) {
        ...
        webShowTimes("61教育综合弹窗");
        _czc.push(['_trackEvent', '曝光次数', '61教育综合弹窗', '', '', '']);
...
function experienceonclick(obj) {
    webBtnClickLog("点击查看成长秘笈","61教育综合弹窗")
    _czc.push(['_trackEvent', '点击查看成长秘笈', '61教育综合弹窗', '', '', '']);
    coocaaosapi.startHomeCommonList("10738", function(message) {
        exit();
    }, function(error) { console.log(error); })
}
